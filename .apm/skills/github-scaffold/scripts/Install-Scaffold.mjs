...
function generateWorkspace(seedWorkspaceText, layout, bcqualityHome) {
  ...
  const comment = layout === 'split'
    ? '// Multi-root workspace for ALDC (App/+Test/ layout, generated by github-scaffold).\n// Root 3 is the BCQuality knowledge base, cloned OUTSIDE the AL project (see\n// tools/bcquality/install.sh). If it shows as missing, run that script.\n'
    : '// Multi-root workspace for ALDC (generated by github-scaffold).\n// Root 2 is the BCQuality knowledge base, cloned OUTSIDE the AL project (see\n// tools/bcquality/install.sh). If it shows as missing, run that script.\n';
