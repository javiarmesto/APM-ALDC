...
description: Generate optimized natural language instructions for Business Central
  agents (Designer or SDK). Follows Responsibilities-Guidelines-Instructions framework.
  Output stored in .resources/Instructions/InstructionsV1.txt for SDK agents.
---
